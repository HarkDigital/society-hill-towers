...
STAGES = [
    ...
    S('build', 'build.py',
      inputs=['template.html', 'style.css', 'three.min.js', 'app.js', 'scene.json', 'meta.json?', 'about_body.html?',
              ...
              'poles.b64?', 'paved.b64?', 'outskirts.b64?', 'city_limit.json?', 'parking_south.json?', 'storefronts.b64?', 'markets.json?', 'markers.json?', 'lights.json?', 'landmarks.json?', 'rail_amtrak.json?', 'brand/dist/favicon.svg', 'brand/dist/favicon-32.png', 'brand/dist/apple-touch-icon.png'],
