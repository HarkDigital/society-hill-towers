...
STAGES = [
    ...
    S('pack_outskirts', 'pack_outskirts.py',
      inputs=['osm_outskirts_raw.json'], outputs=['outskirts.b64'], needs=['fetch_outskirts'],
      note='shapely; 1.0 m units, rows fused with a 3 m bridge, no LiDAR / OPA / roof join across the line'),
