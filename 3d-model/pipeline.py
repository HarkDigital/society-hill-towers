...
STAGES = [
    ...
    S('pack_wide', 'pack_wide.py',
      inputs=['scene_wide.json', 'scene_south.json?', 'parts_wide.json?', 'wide_landmarks_research.json?', 'lidar_cache/roof_shapes.json?', 'lidar_city_roofs.json?'],
      outputs=['wide.b64'], needs=['process_wide', 'process_south', 'lidar_join', 'patch_scenes_facade', 'roof_tags', 'fetch_lidar_roofs'],
    ...
    S('bake_wall_colors', 'bake_wall_colors.py',
      ...
      needs=['fetch_mapillary', 'process_wide', 'process_south'], note='block-face wall colours from the thumbnails; not in the build until a real pass exists'),
