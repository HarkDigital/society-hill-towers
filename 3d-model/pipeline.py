...
STAGES = [
    ...
    S('build', 'build.py',
      inputs=['template.html', 'style.css', 'three.min.js', 'app.js', 'scene.json', 'meta.json?', 'about_body.html?',
              ...
              'poles.b64?', 'brand/dist/favicon.svg', 'brand/dist/favicon-32.png', 'brand/dist/apple-touch-icon.png'],
      outputs=['society-hill-towers.html'],
      needs=['process_core', 'pack_wide', 'pack_city', 'patch_scenes_facade', 'bake_street_labels', 'bake_street_sdf',
