...
STAGES = [
    ...
    S('build', 'build.py',
      ...
      needs=['process_core', 'pack_wide', 'pack_city', 'pack_outskirts', 'fetch_boundary', 'fetch_parking', 'bake_storefronts', 'bake_towers', 'patch_scenes_facade', 'bake_street_labels', 'bake_street_sdf',
