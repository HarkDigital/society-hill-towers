...
STAGES = [
    ...
    S('bake_septa_stops', 'bake_septa_stops.py',
      inputs=['lidar_cache/septa_raw/gtfs_public.zip', 'lidar_cache/septa_raw/station_id_name.csv', 'city_limit.json'],
      outputs=['septa_stops.json'], needs=['fetch_septa_stops'],
    ...
    S('build', 'build.py',
      ...
      needs=['process_core', 'pack_wide', 'pack_city', 'pack_outskirts', 'fetch_boundary', 'fetch_parking', 'bake_storefronts', 'bake_towers', 'bake_schuylkill', 'bake_delaware', 'bake_rail', 'patch_scenes_facade', 'bake_street_labels', 'bake_street_sdf',
             'pack_trees', 'bake_places', 'bake_markets', 'bake_markers', 'bake_lights', 'bake_landmarks', 'bake_overpasses', 'bake_traffic', 'fetch_dem_nw', 'fetch_nw_parks',
