...
STAGES = [
    ...
    S('build', 'build.py',
      inputs=['template.html', 'style.css', 'three.min.js', 'app.js', 'scene.json', 'meta.json?', 'about_body.html?',
              ...
              'poles.b64?', 'paved.b64?', 'outskirts.b64?', 'city_limit.json?', 'parking_south.json?', 'storefronts.b64?', 'markets.json?', 'markers.json?', 'lights.json?', 'landmarks.json?', 'rail_amtrak.json?', 'patco.json?', 'septa_stops.json?', 'civic.json?', 'brand/dist/favicon.svg', 'brand/dist/favicon-32.png', 'brand/dist/apple-touch-icon.png'],
      outputs=['society-hill-towers.html'],
      needs=['process_core', 'pack_wide', 'pack_city', 'pack_outskirts', 'fetch_boundary', 'fetch_parking', 'bake_storefronts', 'bake_towers', 'bake_schuylkill', 'bake_delaware', 'bake_rail', 'bake_patco', 'patch_scenes_facade', 'bake_street_labels', 'bake_street_sdf',
