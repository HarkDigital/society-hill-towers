...
STAGES = [
    ...
    S('build', 'build.py',
      inputs=['template.html', 'style.css', 'three.min.js', 'app.js', 'scene.json', 'meta.json?', 'about_body.html?',
              ...
              'poles.b64?', 'paved.b64?', 'outskirts.b64?', 'city_limit.json?', 'parking_south.json?', 'storefronts.b64?', 'markets.json?', 'brand/dist/favicon.svg', 'brand/dist/favicon-32.png', 'brand/dist/apple-touch-icon.png'],
      ...
      needs=['process_core', 'pack_wide', 'pack_city', 'pack_outskirts', 'fetch_boundary', 'fetch_parking', 'bake_storefronts', 'bake_towers', 'bake_schuylkill', 'bake_delaware', 'patch_scenes_facade', 'bake_street_labels', 'bake_street_sdf',
             'pack_trees', 'bake_places', 'bake_markets', 'bake_overpasses', 'bake_traffic', 'fetch_dem_nw', 'fetch_nw_parks',
