...
- **Layers panel (F):** SEPTA vehicles (V; JSONP polls of TransitViewAll, street-snapped,
  ...
  camera-weighted budget), street closures (U; Round 79: `/closures.json` baked every 30 min by
...
- Marker visibility is a per-family owner decision: SEPTA/Indego markers and the ground pins (Round 82) are occluded by
